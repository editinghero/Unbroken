                ...
                <SafeAreaView style={styles.safeArea} edges={['bottom', 'left', 'right']}>
                    <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
                        <View style={styles.statsGrid}>
                            <View style={styles.glowWrapperLarge}>
                                <BlurView intensity={40} tint="dark" experimentalBlurMethod="dimezisBlurView" style={styles.statCardLarge}>
                        ...
                        <View style={styles.section}>
                            ...
                            <View style={styles.glowWrapper}>
                                <BlurView intensity={30} tint="dark" experimentalBlurMethod="dimezisBlurView" style={styles.performanceCard}>
                            ...
                            <View style={[styles.glowWrapper, { marginTop: 12 }]}>
                                <BlurView intensity={30} tint="dark" experimentalBlurMethod="dimezisBlurView" style={styles.performanceCard}>
                                    <View style={styles.performanceHeader}>
                    ...
                    <BlurView
                        ...
                        style={[styles.bottomNavBar, { paddingBottom: insets.bottom + 12 }]}
                    >
