                ...
                <SafeAreaView style={styles.safeArea} edges={['bottom', 'left', 'right']}>
                    ...
                    >
                        <View style={styles.glowWrapperLarge}>
                            <BlurView intensity={40} tint="dark" experimentalBlurMethod="dimezisBlurView" style={styles.calendarCard}>
                        ...
                        <View style={styles.glowWrapperSmall}>
                            <BlurView intensity={30} tint="dark" experimentalBlurMethod="dimezisBlurView" style={styles.infoCard}>
